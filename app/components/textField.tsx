...
export function DurationField() {
  return (
    <Box
      ...
      className="my-2"
    >
      <TextField sx={{}} id="outlined-basic" label="Duração" variant="outlined" className="bg-black/40 rounded-md h-13 ml-3" />
    </Box>
  )
}
  ...
  return (
    <div className="flex">
      <Box
        ...
        className="my-2"
      >
        <TextField sx={{}} id="outlined-basic" label="Número de artistas" variant="outlined" className="bg-black/40 rounded-md h-13 ml-3" />
      </Box>
  ...
  return (
    <div className="flex">
      <Box
        ...
        className="my-2"
      >
        <TextField sx={{}} id="outlined-basic" label="Seguidores no Spotify" variant="outlined" className="bg-black/40 rounded-md h-13 ml-3" />
      </Box>
      <div className="flex-1 pl-2 pt-6">
        <span className="relative overflow-hidden cursor-pointer group hover:overflow-visible focus-visible:outline-none" aria-describedby="tooltip-03">
          <svg width="20" height="20" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className="flex">
      <Box
        ...
        className="my-2"
      >
        <TextField sx={{}} id="outlined-basic" label="Volume (dB)" variant="outlined" className="bg-black/40 rounded-md h-13 ml-3" />
      </Box>
      <div className="flex-1 pl-2 pt-6">
        <span className="relative overflow-hidden cursor-pointer group hover:overflow-visible focus-visible:outline-none" aria-describedby="tooltip-03">
          <svg width="20" height="20" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
